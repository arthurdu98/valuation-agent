...
from src.backend.data.base import DataAdapter
...
class DataCollector:
    ...
    def _default_adapters(self) -> dict[Market, list[DataAdapter]]:
        from src.backend.data.adapters.ashare import AShareAdapter
        from src.backend.data.adapters.us import USAdapter
        ...
        try:
            from src.backend.data.adapters.hk import HKAdapter
            ...
            adapters[Market.HK] = []
        try:
            from src.backend.data.adapters.ashare_tushare import TushareAdapter
