...
from src.backend.data.industry.internet import InternetPlugin
from src.backend.data.industry.tcm import TCMPlugin
from src.backend.data.industry.toy import ToyPlugin
from src.backend.api.run_registry import registry
